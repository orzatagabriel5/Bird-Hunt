...
void Lab5::Update(float deltaTimeSeconds)
{
    ...
    {
        glm::mat4 modelMatrix = glm::mat4(1);
        modelMatrix = glm::translate(modelMatrix, glm::vec3(-1.0f, 2.f, 0));
        modelMatrix = glm::rotate(modelMatrix, RADIANS(45.f), glm::vec3(2.f, 1.5f, 0));
        modelMatrix = glm::scale(modelMatrix, glm::vec3(1.f, 2.f, .3f));
        RenderMesh(meshes["box"], shaders["VertexNormal"], modelMatrix);
    }

    {
        glm::mat4 modelMatrix = glm::mat4(1);
        modelMatrix = glm::translate(modelMatrix, glm::vec3(2.5f, 2.5f, -3.f));
        modelMatrix = glm::rotate(modelMatrix, RADIANS(180.f), glm::vec3(0.8f, 0, 0.5f));
        modelMatrix = glm::scale(modelMatrix, glm::vec3(.8f, 1.f, 2.5f));
        RenderMesh(meshes["box"], shaders["VertexNormal"], modelMatrix);
    }
