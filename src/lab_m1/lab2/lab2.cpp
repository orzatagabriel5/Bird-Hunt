...
void Lab2::Init()
{
    ...
    // Create a mesh box using custom data
    {
        ...
        {
            //VertexFormat(glm::vec3(0, 0, 1), glm::vec3(1, 0, 1), glm::vec3(0, 1, 1),
             //            glm::vec3(1, 1, 1), glm::vec3(0, 0, 0), glm::vec3(1, 0, 0),
        ...
        vector<VertexFormat> vertices2
        {
            ...
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(1, 0, 0)),
            VertexFormat(glm::vec3(0.5, 2, 0.5), glm::vec3(1, 0, 0))
        ...
        CreateMesh("trt", vertices2, indices2);
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["trt"], shaders["VertexColor"], glm::vec3(0, 0, 0), glm::vec3(1));

    // TODO(student): Draw the square

    RenderMesh(meshes["patrat"], shaders["VertexColor"], glm::vec3(1, 1, 1), glm::vec3(2));
